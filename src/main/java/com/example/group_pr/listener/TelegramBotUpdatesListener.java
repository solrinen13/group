...
import static com.example.group_pr.listener.Constants.*;
...
//    }
    ...
    // первая звездочка - секунда (0 - 59), вторая - минута (0 - 59), третья - час (0 - 23), четверная - день месяца(1 - 31), пятая - месяц (1 -12) или (JAN-DEC), шестая - день недели (0 - 7) или (MON-SUN -- 0 или 7 является воскресеньем)
