...
import com.example.group_pr.exception.DogNotFoundException;
...
/**
 * Сервисный класс, содержащий CRUD-методы объекта класса Dog
 *
 * @see Dog
 * @see DogRepository
 */
...
public class DogShelterService {
    ...
    public DogShelterService(DogRepository dogRepository) {
